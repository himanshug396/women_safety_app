...
/**
 * Generated class for the ClickAndUploadPage page.
 *
...
@Component({
  selector: 'page-click-and-upload',
  templateUrl: 'click-and-upload.html',
})
export class ClickAndUploadPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ClickAndUploadPage');
  }
